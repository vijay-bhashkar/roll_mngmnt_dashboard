  ...
  return (
    <>
      <DialogContent className='overflow-visible pbs-0 sm:pli-16'>
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Full Name' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Email' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Password' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Role' className='mbe-2' />
