  ...
  return (
    <>
      <DialogContent className='overflow-visible pbs-0 sm:pli-16'>
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Name' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Category' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Sub Category' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Country' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter State' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter City' className='mbe-2' />
        <CustomTextField fullWidth label='' variant='outlined' placeholder='Enter Mobile' className='mbe-2' />
...
const AdminDialog = ({ open, setOpen, data }) => {
  const handleClose = () => {
    setOpen(false)
  }
